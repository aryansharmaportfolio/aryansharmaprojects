...
const AboutMe = () => {
  ...
  // Handle appearance when scrolling into view
  useEffect(() => {
  ...
  return (
    <section 
      ref={sectionRef} 
      id="about" 
      className="py-24 sm:py-32 md:py-40 px-4 sm:px-6 bg-background relative overflow-hidden"
    >
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        {/* Content grid with slide-in animations */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          
          {/* Left Column - Profile with slide from left */}
          <div 
            className={cn(
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <div className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-primary shadow-2xl relative z-10 transition-transform duration-500 hover:scale-105">
          ...
          {/* Right Column - Bio with slide from right */}
          <div 
            className={cn(
