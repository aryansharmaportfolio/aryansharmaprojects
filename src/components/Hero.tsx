...
const Hero = () => {
  ...
  // Subtle zoom IN on scroll, creates a feeling of moving "into" the scene
  const videoScale = Math.max(1, 1 + scrollY / 2000); 
  
  // Text fades out and moves up slightly as you scroll down
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        ...
        {/* Overlay Gradients - Adds depth and makes text readable */}
      ...
      {/* Scroll Indicator - The "Scroll Hint" you requested */}
      <div 
        className={cn(
          "absolute bottom-10 left-1/2 -translate-x-1/2 z-20 animate-bounce transition-opacity duration-500",
          // Hide the scroll hint as soon as the user starts scrolling
          scrollY > 20 ? "opacity-0" : "opacity-70"
        )}
      >
