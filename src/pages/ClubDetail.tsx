...
const ClubDetail = () => {
  ...
  const clubData: Record<string, any> = {
    ...
    "chs-aerospace": {
      ...
      logo: "https://images.unsplash.com/photo-16147322414444-096e5f1122d5?auto=format&fit=crop&w=800",
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              {club.skills.map((skill: string, index: number) => <span key={index} className="px-4 py-2 bg-card text-card-foreground rounded-lg text-lg font-medium">
                  {skill}
                </span>)}
            </div>
          </div>
