  ...
  return (
    <>
      ...
      <div
        ...
        className={cn("fixed top-0 left-0 h-full group z-50", !isMobile && "cursor-pointer")}
      >
        <div
          onClick={isMobile ? toggleSidebar : undefined}
          className={cn(
            "absolute left-0 w-16 bg-black/60 backdrop-blur-md border-t-2 border-b-2 border-r-2 border-white/10 shadow-2xl flex items-center justify-center transition-all duration-500 ease-in-out",
